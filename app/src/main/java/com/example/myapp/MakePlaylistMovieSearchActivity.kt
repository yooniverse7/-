...
class MakePlaylistMovieSearchActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        SearchButton.setOnClickListener {
            ...
            val intent = Intent(this, MakePlaylistMovieSearchResultsActivity::class.java)
        ...
        imageAdapter = MakePlaylistMovieSearchResultsAdapter(
            this@MakePlaylistMovieSearchActivity,
            imageUrlList,
            nameList,
            textList,
            urlList
        ...
        recyclerView.layoutManager =
            LinearLayoutManager(this@MakePlaylistMovieSearchActivity)
